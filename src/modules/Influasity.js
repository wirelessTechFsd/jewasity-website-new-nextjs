...
export default function Influasity() {
  ...
  const { influencity, loading } = useSelector((state) => state?.influencer);
  useEffect(() => {
            ...
            <div>
              ...
              <div className="mt-[90.8px]">
                ...
                <div className="mt-[120px]">
                  <div className="flex items-center gap-[14px] mb-[33px] justify-between flex-wrap">
                    ...
                    <div className="flex items-center gap-[14px] ">
                      <Image
                        ...
                        width={60}
                      />
                      <p className="text-[35px] font-regular">{item?.name}</p>
                    </div>
                    <p className="max-w-[700px]">{item?.description}</p>
                  </div>
