...
export default function CustomDatePicker({
  ...
  const ExampleCustomInput = forwardRef(({ value, onClick }, ref) => (
    <Button
      ...
      subText={
        isDateFilterApplied ? moment(startDate).format("DD/MM/YY") : "Date"
      }
      subTextStyle={"text-[11px] text-grey-dark opacity-[0.6] font-regular"}
      icon={<img src="/icons/circularCalender.svg" alt="calendar-icon" />}
    />
  ));

  // Adding displayName to the ExampleCustomInput component
